...
<div class="container mt-4 justify-content-center">
    ...
    <h3 class="fst-italic">The standard Lorem Ipsum passage, used since the 1500s</h3>
    <p class="text-start">
...
Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum."
    ...
    <h3 class="fst-italic">Section 1.10.32 of "de Finibus Bonorum et Malorum", written by Cicero in 45 BC</h3>
<p class="text-start">
...
vel illum qui dolorem eum fugiat quo voluptas nulla pariatur?"
    ...
    <h3 class="fst-italic">1914 translation by H. Rackham</h3>
<p class="text-start">
"But I must explain to you how all this mistaken idea of denouncing pleasure and praising pain was born and
    ...
    <h3 class="fst-italic">Section 1.10.33 of "de Finibus Bonorum et Malorum", written by Cicero in 45 BC</h3>
<p class="text-start">
